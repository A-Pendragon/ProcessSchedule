...
public class MainWindow extends javax.swing.JFrame {
    ...
    private void computeButtonActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_computeButtonActionPerformed
        ...
        ProcessOperation pa = new ProcessOperation(TableHandlers.addValuesToProcess(processType, table)); // Add process from table.
        TableHandlers.doProcessOperation(processType, pa); // Do the Process operation.
